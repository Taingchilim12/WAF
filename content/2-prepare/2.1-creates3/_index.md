...
* Click **Create bucket**.
![Create S3](/WAF/images/2-prepare/2.1-creates3/creates3-001.png?featherlight=false&width=90px)
...
{{% /notice %}}
![Create S3](/images/2-prepare/2.1-creates3/creates3-002.png?featherlight=false&width=90px)
3. Drag the screen down, then click **Create bucket**.
![Create S3](/images/2-prepare/2.1-creates3/creates3-003.png?featherlight=false&width=90px)
4. Make sure the bucket is successfully created as shown below, before proceeding to the next steps.
![Create S3](/images/2-prepare/2.1-creates3/creates3-004.png?featherlight=false&width=90px)
